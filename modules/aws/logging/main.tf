...
resource "aws_s3_bucket" "logging" {
  ...
  bucket = "${var.prefix}-logs-${coalesce(var.account_id, "000000000000")}-${var.primary_region}"
...
resource "aws_s3_bucket" "cloudtrail" {
  ...
  bucket = "${var.prefix}-cloudtrail-${coalesce(var.account_id, "000000000000")}-${var.primary_region}"
